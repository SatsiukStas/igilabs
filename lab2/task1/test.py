...
class TestGetAverageSentenceLength(unittest.TestCase):
    ...
    def test_abbreviations(self):
        text = 'Hello, Mr. Berek. Sample text i.e. and more Ph.D. - it\'s greate text!!'
...
class TestGetTopKRepeatedNgram(unittest.TestCase):
    ...
    def test_text_without_repeated_anagrams(self):
        text = 'Hello, My name is Stas. And theres no repeated words.'
        expected = [('hello my name', 1), ('my name is', 1), ('name is stas', 1)]
